...
export function parseReference(input: string): {
  ...
  // Match patterns like "John 3:16", "1 Corinthians 13:4-7", "Psalm 23"
  ...
  const book = BIBLE_BOOKS.find(b => 
    ...
    b.abbr.toLowerCase() === bookLower ||
    b.name.toLowerCase().startsWith(bookLower)
  );
...
// Format a time for display (e.g., 8 -> "8:00 AM", 14 -> "2:00 PM")
export function formatDeliveryTime(hour: number, minute: number = 0): string {
